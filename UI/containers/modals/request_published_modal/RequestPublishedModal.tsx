...
type NavigationProp = CompositeNavigationProp<
  StackNavigationProp<MainStackParamList, 'Check'>,
  BottomTabNavigationProp<BottomTabParamList>
>;
interface RequestPublishedModalProps {}
export default function RequestPublishedModal({}: RequestPublishedModalProps) {
  const { close } = useOverlayStore();
  const navigation = useNavigation<NavigationProp>();
  return (
    <View style={styles.RequestPublishedModal}>
      <BorderContainer>
        <Animatable.View
          animation="bounceIn"
          duration={2000}
